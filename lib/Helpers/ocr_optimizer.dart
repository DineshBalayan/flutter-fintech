...
class PhotoOptimizerForOCR {
  ...
  static Future<Map<String?, IfdTag>?> getPhotoFileMeta(String path) async {
    Future<Map<String?, IfdTag>?> _meta =
  ...
  static Future<bool> optimizeByResize(String path,
    ...
    int _h = 0;
    Map<String?, IfdTag>? _meta =
        await PhotoOptimizerForOCR.getPhotoFileMeta(path);
    ...
    if (_meta == null ||
      ...
      _w = _meta[PhotoOptimizerForOCR.exifTagImageWidth]!.values![0] as int;
      _h = _meta[PhotoOptimizerForOCR.exifTagImageLength]!.values![0] as int;
    }
