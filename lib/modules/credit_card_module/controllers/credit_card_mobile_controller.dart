...
class CreditCardMobileController extends BaseController {
  ...
  sendOtpToLeadMobile() {
    ...
    restClient
        .verifyOtpCard(LoginRequest(mobile_no: mobileNoController.text))
        .then((value) async {
      if (value.success) {
        pageState = PageStates.PAGE_IDLE;
        arguments.mobileNo = mobileNoController.text;
        arguments.cardData = value.data;
        Get.offAndToNamed(Routes.CREDITCARDApplication, arguments: arguments);
      } else {
